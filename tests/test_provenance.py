import tempfile
from descformats.provenance import Provenance, errors, utils
from descformats.provenance.provenance import writable_value
from descformats import __version__ as lib_version
...
def test_generate():
    ...
    assert p["versions", "descformats"] == lib_version
...
def test_writeable():
    ...
    assert writable_value(4) == 4
    assert writable_value(4.0) == 4.0
    assert writable_value("sss") == "sss"
